...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">les problèmes de l'afrique</a>
			<button
    ...
    <div class="row">
        <div class="col-lg-4 ms-auto">
            <p class="lead">L'Afrique est confrontée à divers défis, dont des problèmes de santé majeurs tels que la prévalence de maladies graves. Les populations luttent contre des maladies telles que le paludisme, le VIH/SIDA et d'autres affections qui affectent la qualité de vie.</p>
        </div>
        <div class="col-lg-4 me-auto">
            <p class="lead">De plus, le continent africain fait face à des défis liés à la pénurie de ressources marines, limitant les opportunités économiques et alimentaires. Les communautés côtières ont besoin de solutions durables pour surmonter ces problèmes.</p>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <!-- Icônes Sociales du Pied de Page -->
            <div class="col-lg-4 mb-5 mb-lg-0">
            ...
            <div class="col-lg-4">
                <h4 class="text-uppercase mb-4">À Propos de notre Cause</h4>
                <p class="lead mb-0">
                    Notre mission est de sensibiliser aux défis de l'Afrique, notamment en matière de santé et de ressources marines. Ensemble, travaillons pour des solutions durables et un avenir meilleur.
                </p>
            </div>
        </div>
    </div>
